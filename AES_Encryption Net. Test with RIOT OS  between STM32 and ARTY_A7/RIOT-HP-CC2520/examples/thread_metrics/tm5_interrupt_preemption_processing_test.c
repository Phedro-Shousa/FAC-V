...
#define OUT_PIN (GPIO_PIN(PORT_E, 8))
#define IN_PIN (GPIO_PIN(PORT_A, 0))
...
void * tm_interrupt_preemption_thread_1_entry(void * arg)
{
    ...
    while(1)
    {
		...
		gpio_clear(OUT_PIN);
	  	/*/
	  	asm volatile (	" mov r7, #69 	\n"
						" svc #69		\n" ::: "r7"); //*/  // This is Cortex-M specific.  
...
/* void  tm_interrupt_preemption_handler(void)  */
 void tm_interrupt_preemption_handler()        /* This is Cortex-M specific  */
{
