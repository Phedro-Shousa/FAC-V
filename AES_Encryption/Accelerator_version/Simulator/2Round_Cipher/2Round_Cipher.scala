...
//========================================================///
  ...
  when(io.start && (io.en && !io.de)){
    when(E_round === 0.U){
      ...
      io.out(2) := 0.U 
      io.out(3) := 0.U 
    }.elsewhen((E_round =/= 0.U) && (E_round =/= 5.U)){
      ...
      round2(0) := Cat(En_Line0(SubShiftRow(round1(0), round1(1), round1(2), round1(3))), 
                        ...
                        En_Line3(SubShiftRow(round1(0), round1(1), round1(2), round1(3)))) ^ key((E_round*8.U))
      round2(1) := Cat(En_Line0(SubShiftRow(round1(1), round1(2), round1(3), round1(0))), 
                        ...
                        En_Line3(SubShiftRow(round1(1), round1(2), round1(3), round1(0)))) ^ key((E_round*8.U)+1.U)
      round2(2) := Cat(En_Line0(SubShiftRow(round1(2), round1(3), round1(0), round1(1))), 
                        ...
                        En_Line3(SubShiftRow(round1(2), round1(3), round1(0), round1(1)))) ^ key((E_round*8.U)+2.U)
      round2(3) := Cat(En_Line0(SubShiftRow(round1(3), round1(0), round1(1), round1(2))), 
                        ...
                        En_Line3(SubShiftRow(round1(3), round1(0), round1(1), round1(2)))) ^ key((E_round*8.U)+3.U)    

      round1(0) :=  Cat(En_Line0(SubShiftRow(round2(0), round2(1), round2(2), round2(3))), 
                        En_Line1(SubShiftRow(round2(0), round2(1), round2(2), round2(3))), 
                        En_Line2(SubShiftRow(round2(0), round2(1), round2(2), round2(3))), 
                        En_Line3(SubShiftRow(round2(0), round2(1), round2(2), round2(3)))) ^ key((E_round*8.U)+4.U)
      round1(1) :=  Cat(En_Line0(SubShiftRow(round2(1), round2(2), round2(3), round2(0))), 
                        En_Line1(SubShiftRow(round2(1), round2(2), round2(3), round2(0))), 
                        En_Line2(SubShiftRow(round2(1), round2(2), round2(3), round2(0))), 
                        En_Line3(SubShiftRow(round2(1), round2(2), round2(3), round2(0)))) ^ key((E_round*8.U)+5.U)
      round1(2) :=  Cat(En_Line0(SubShiftRow(round2(2), round2(3), round2(0), round2(1))), 
                        En_Line1(SubShiftRow(round2(2), round2(3), round2(0), round2(1))), 
                        En_Line2(SubShiftRow(round2(2), round2(3), round2(0), round2(1))), 
                        En_Line3(SubShiftRow(round2(2), round2(3), round2(0), round2(1)))) ^ key((E_round*8.U)+6.U)
      round1(3) :=  Cat(En_Line0(SubShiftRow(round2(3), round2(0), round2(1), round2(2))), 
                        En_Line1(SubShiftRow(round2(3), round2(0), round2(1), round2(2))), 
                        En_Line2(SubShiftRow(round2(3), round2(0), round2(1), round2(2))), 
                        En_Line3(SubShiftRow(round2(3), round2(0), round2(1), round2(2)))) ^ key((E_round*8.U)+7.U)        
    ...
    when(D_round === 0.U){         
      ...
      io.out(2) := 0.U 
      io.out(3) := 0.U 
    }.elsewhen((D_round =/= 0.U) && (D_round =/= 5.U)){
                         
      round2(0) :=  Cat(De_Line0(InvSubShiftRow(round1(0), round1(3), round1(2), round1(1)) ^ key_d(D_round*8.U)), 
                        De_Line1(InvSubShiftRow(round1(0), round1(3), round1(2), round1(1)) ^ key_d(D_round*8.U)), 
                        De_Line2(InvSubShiftRow(round1(0), round1(3), round1(2), round1(1)) ^ key_d(D_round*8.U)), 
                        De_Line3(InvSubShiftRow(round1(0), round1(3), round1(2), round1(1)) ^ key_d(D_round*8.U))) 
      round2(1) :=  Cat(De_Line0(InvSubShiftRow(round1(1), round1(0), round1(3), round1(2)) ^ key_d((D_round*8.U)+1.U)), 
                        De_Line1(InvSubShiftRow(round1(1), round1(0), round1(3), round1(2)) ^ key_d((D_round*8.U)+1.U)), 
                        De_Line2(InvSubShiftRow(round1(1), round1(0), round1(3), round1(2)) ^ key_d((D_round*8.U)+1.U)), 
                        De_Line3(InvSubShiftRow(round1(1), round1(0), round1(3), round1(2)) ^ key_d((D_round*8.U)+1.U))) 
      round2(2) :=  Cat(De_Line0(InvSubShiftRow(round1(2), round1(1), round1(0), round1(3)) ^ key_d((D_round*8.U)+2.U)), 
                        De_Line1(InvSubShiftRow(round1(2), round1(1), round1(0), round1(3)) ^ key_d((D_round*8.U)+2.U)), 
                        De_Line2(InvSubShiftRow(round1(2), round1(1), round1(0), round1(3)) ^ key_d((D_round*8.U)+2.U)), 
                        De_Line3(InvSubShiftRow(round1(2), round1(1), round1(0), round1(3)) ^ key_d((D_round*8.U)+2.U))) 
      round2(3) :=  Cat(De_Line0(InvSubShiftRow(round1(3), round1(2), round1(1), round1(0)) ^ key_d((D_round*8.U)+3.U)), 
                        De_Line1(InvSubShiftRow(round1(3), round1(2), round1(1), round1(0)) ^ key_d((D_round*8.U)+3.U)), 
                        De_Line2(InvSubShiftRow(round1(3), round1(2), round1(1), round1(0)) ^ key_d((D_round*8.U)+3.U)), 
                        De_Line3(InvSubShiftRow(round1(3), round1(2), round1(1), round1(0)) ^ key_d((D_round*8.U)+3.U))) 
                         
      round1(0) :=  Cat(De_Line0(InvSubShiftRow(round2(0), round2(3), round2(2), round2(1)) ^ key_d((D_round*8.U)+4.U)), 
                        De_Line1(InvSubShiftRow(round2(0), round2(3), round2(2), round2(1)) ^ key_d((D_round*8.U)+4.U)), 
                        De_Line2(InvSubShiftRow(round2(0), round2(3), round2(2), round2(1)) ^ key_d((D_round*8.U)+4.U)), 
                        De_Line3(InvSubShiftRow(round2(0), round2(3), round2(2), round2(1)) ^ key_d((D_round*8.U)+4.U))) 
      round1(1) :=  Cat(De_Line0(InvSubShiftRow(round2(1), round2(0), round2(3), round2(2)) ^ key_d((D_round*8.U)+5.U)), 
                        De_Line1(InvSubShiftRow(round2(1), round2(0), round2(3), round2(2)) ^ key_d((D_round*8.U)+5.U)), 
                        De_Line2(InvSubShiftRow(round2(1), round2(0), round2(3), round2(2)) ^ key_d((D_round*8.U)+5.U)), 
                        De_Line3(InvSubShiftRow(round2(1), round2(0), round2(3), round2(2)) ^ key_d((D_round*8.U)+5.U))) 
      round1(2) :=  Cat(De_Line0(InvSubShiftRow(round2(2), round2(1), round2(0), round2(3)) ^ key_d((D_round*8.U)+6.U)), 
                        De_Line1(InvSubShiftRow(round2(2), round2(1), round2(0), round2(3)) ^ key_d((D_round*8.U)+6.U)), 
                        De_Line2(InvSubShiftRow(round2(2), round2(1), round2(0), round2(3)) ^ key_d((D_round*8.U)+6.U)), 
                        De_Line3(InvSubShiftRow(round2(2), round2(1), round2(0), round2(3)) ^ key_d((D_round*8.U)+6.U))) 
      round1(3) :=  Cat(De_Line0(InvSubShiftRow(round2(3), round2(2), round2(1), round2(0)) ^ key_d((D_round*8.U)+7.U)), 
                        De_Line1(InvSubShiftRow(round2(3), round2(2), round2(1), round2(0)) ^ key_d((D_round*8.U)+7.U)), 
                        De_Line2(InvSubShiftRow(round2(3), round2(2), round2(1), round2(0)) ^ key_d((D_round*8.U)+7.U)), 
                        De_Line3(InvSubShiftRow(round2(3), round2(2), round2(1), round2(0)) ^ key_d((D_round*8.U)+7.U))) 
      D_round := D_round + 1.U
      io.ready := false.B
      io.reset := false.B
      io.out(0) := 0.U 
      ...
      io.out(0) :=  Cat(InvSubShiftRow(round1(0), round1(3), round1(2), round1(1)) ^ key_d((c.NumberRounds*4)), 
                        InvSubShiftRow(round1(0), round1(3), round1(2), round1(1)) ^ key_d((c.NumberRounds*4)), 
                        InvSubShiftRow(round1(0), round1(3), round1(2), round1(1)) ^ key_d((c.NumberRounds*4)), 
                        InvSubShiftRow(round1(0), round1(3), round1(2), round1(1)) ^ key_d((c.NumberRounds*4))) 
      io.out(1) :=  Cat(InvSubShiftRow(round1(1), round1(0), round1(3), round1(2)) ^ key_d((c.NumberRounds*4)+1), 
                        InvSubShiftRow(round1(1), round1(0), round1(3), round1(2)) ^ key_d((c.NumberRounds*4)+1), 
                        InvSubShiftRow(round1(1), round1(0), round1(3), round1(2)) ^ key_d((c.NumberRounds*4)+1), 
                        InvSubShiftRow(round1(1), round1(0), round1(3), round1(2)) ^ key_d((c.NumberRounds*4)+1)) 
      io.out(2) :=  Cat(InvSubShiftRow(round1(2), round1(1), round1(0), round1(3)) ^ key_d((c.NumberRounds*4)+2), 
                        InvSubShiftRow(round1(2), round1(1), round1(0), round1(3)) ^ key_d((c.NumberRounds*4)+2), 
                        InvSubShiftRow(round1(2), round1(1), round1(0), round1(3)) ^ key_d((c.NumberRounds*4)+2), 
                        InvSubShiftRow(round1(2), round1(1), round1(0), round1(3)) ^ key_d((c.NumberRounds*4)+2)) 
      io.out(3) :=  Cat(InvSubShiftRow(round1(3), round1(2), round1(1), round1(0)) ^ key_d((c.NumberRounds*4)+3), 
                        InvSubShiftRow(round1(3), round1(2), round1(1), round1(0)) ^ key_d((c.NumberRounds*4)+3), 
                        InvSubShiftRow(round1(3), round1(2), round1(1), round1(0)) ^ key_d((c.NumberRounds*4)+3), 
                        InvSubShiftRow(round1(3), round1(2), round1(1), round1(0)) ^ key_d((c.NumberRounds*4)+3)) 
      io.ready := true.B
      io.reset := false.B
