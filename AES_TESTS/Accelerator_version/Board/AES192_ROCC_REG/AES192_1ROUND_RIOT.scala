...
//========================================================================================================///
class AES_Module(opcodes: OpcodeSet, c: AES_Config = new AES_192)(implicit p: Parameters) extends LazyRoCC(opcodes) {
...
class AES_ModuleImp(outer: AES_Module, c: AES_Config)(implicit p: Parameters) extends LazyRoCCModuleImp(outer)
  ...
  val ReadKey_2 = funct === 4.U
  val Set_en_3 = funct === 5.U
  val Set_de_4 = funct === 6.U
  val ReceiveSize_5 = funct === 7.U
//=====================AES VALUES==================
