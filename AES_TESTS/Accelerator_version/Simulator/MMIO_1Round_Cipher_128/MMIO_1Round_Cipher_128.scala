...
class Cipher_Module(c: AES_Config) extends Module{ //32bit decoder implementation without shifts. Compiler doesn't accept shifts of more than 20bits
...
//========================================================///
  ...
  when(io.start && (io.en && !io.de)){
    ...
    when(D_round === 0.U){         
      ...
      io.out(2) := 0.U 
      io.out(3) := 0.U 
    }.elsewhen((D_round =/= 0.U) && (D_round =/= c.NumberRounds.U)){
                         
      round1(0) :=  Cat(De_Line0(InvSubShiftRow(round1(0), round1(3), round1(2), round1(1)) ^ key_d(D_round*4.U)), 
                        De_Line1(InvSubShiftRow(round1(0), round1(3), round1(2), round1(1)) ^ key_d(D_round*4.U)), 
                        De_Line2(InvSubShiftRow(round1(0), round1(3), round1(2), round1(1)) ^ key_d(D_round*4.U)), 
                        De_Line3(InvSubShiftRow(round1(0), round1(3), round1(2), round1(1)) ^ key_d(D_round*4.U))) 
      round1(1) :=  Cat(De_Line0(InvSubShiftRow(round1(1), round1(0), round1(3), round1(2)) ^ key_d((D_round*4.U)+1.U)), 
                        De_Line1(InvSubShiftRow(round1(1), round1(0), round1(3), round1(2)) ^ key_d((D_round*4.U)+1.U)), 
                        De_Line2(InvSubShiftRow(round1(1), round1(0), round1(3), round1(2)) ^ key_d((D_round*4.U)+1.U)), 
                        De_Line3(InvSubShiftRow(round1(1), round1(0), round1(3), round1(2)) ^ key_d((D_round*4.U)+1.U))) 
      round1(2) :=  Cat(De_Line0(InvSubShiftRow(round1(2), round1(1), round1(0), round1(3)) ^ key_d((D_round*4.U)+2.U)), 
                        De_Line1(InvSubShiftRow(round1(2), round1(1), round1(0), round1(3)) ^ key_d((D_round*4.U)+2.U)), 
                        De_Line2(InvSubShiftRow(round1(2), round1(1), round1(0), round1(3)) ^ key_d((D_round*4.U)+2.U)), 
                        De_Line3(InvSubShiftRow(round1(2), round1(1), round1(0), round1(3)) ^ key_d((D_round*4.U)+2.U))) 
      round1(3) :=  Cat(De_Line0(InvSubShiftRow(round1(3), round1(2), round1(1), round1(0)) ^ key_d((D_round*4.U)+3.U)), 
                        De_Line1(InvSubShiftRow(round1(3), round1(2), round1(1), round1(0)) ^ key_d((D_round*4.U)+3.U)), 
                        De_Line2(InvSubShiftRow(round1(3), round1(2), round1(1), round1(0)) ^ key_d((D_round*4.U)+3.U)), 
                        De_Line3(InvSubShiftRow(round1(3), round1(2), round1(1), round1(0)) ^ key_d((D_round*4.U)+3.U))) 
      D_round := D_round + 1.U
      io.ready := false.B
      io.reset := false.B
      io.out(0) := 0.U 
...
trait AESModule extends HasRegMap {
  ...
  val En_De = Wire(new DecoupledIO(UInt(2.W)))
  ...
  regmap(
    ...
    0x14 -> Seq(RegField(32, message(0))),
    0x18 -> Seq(RegField(32, message(1))),
    0x1C -> Seq(RegField(32, message(2))),
    0x20 -> Seq(RegField(32, message(3))),
    0x24 -> Seq(RegField.w(2, En_De))) 
